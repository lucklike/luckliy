...
public abstract class AbstractConfigurableEnvironment implements ConfigurableEnvironment {
     ...
     */
    public static final String IGNORE_GETENV_PROPERTY_NAME = "lucky.getenv.ignore";
     ...
     */
    public static final String ACTIVE_PROFILES_PROPERTY_NAME = "lucky.profiles.active";
     ...
     */
    public static final String DEFAULT_PROFILES_PROPERTY_NAME = "lucky.profiles.default";
     ...
     * @see ConfigurableEnvironment#setDefaultProfiles
     * @see ConfigurableEnvironment#setActiveProfiles
     * @see org.springframework.core.env.AbstractEnvironment#DEFAULT_PROFILES_PROPERTY_NAME
     ...
     * @see #customizePropertySources(MutablePropertySources)
     */
    protected AbstractConfigurableEnvironment(MutablePropertySources propertySources) {
     ...
     * callback is invoked by the {@link #AbstractConfigurableEnvironment()} constructor, which may
     ...
     * @see #AbstractConfigurableEnvironment()
     ...
     * @see LuckyProperties#getFlag
     */
    protected boolean suppressGetenvAccess() {
        return LuckyProperties.getFlag(IGNORE_GETENV_PROPERTY_NAME);
    }
