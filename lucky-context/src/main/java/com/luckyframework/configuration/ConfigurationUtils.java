...
public class ConfigurationUtils {
    ...
    public static ConfigurationMap getDefaultConfigurationMap(){
        ...
        switch (CONF_TYPE){
            case YAML       : return loadYaml(reader);
            case PROPERTIES : return loadProperties(reader);
            case JSON       : return loadJson(reader);
            default         : return new ConfigurationMap();
        }
    }
    ...
    public static ConfigurationMap loaderReader(String name, Reader reader){
        ...
        switch (exName){
            case YAML:
            case YML        : return loadYaml(reader);
            case PROPERTIES : return loadProperties(reader);
            case JSON       : return loadJson(reader);
            default: throw new IllegalArgumentException("Unsupported file types:" + name);
        }
    }
    ...
    public static ConfigurationMap loadYaml(Reader yamlReader){
        ...
        for (Object entryObject : iterable) {
            ...
            map.addConfigProperties(tempMap);
            break;
        }
        return map;
    }
    ...
    public static ConfigurationMap loadProperties(Reader propertiesReader){
        ...
        try {
            ...
            for (Map.Entry<Object, Object> entry : properties.entrySet()) {
                ...
                map.addConfigProperty(key,value);
            }
