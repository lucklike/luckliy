...
public final class BeanDefinitionBuilder {
    ...
    public static GenericBeanDefinition builder(@NonNull FactoryBean factory, AnnotatedTypeMetadata beanAnnotatedTypeMetadata) {
        ...
        if (beanAnnotatedTypeMetadata instanceof ClassMetadata) {
            ...
            definition.setPropertyValue(PropertyInjectionUtils.getInjectionPropertyValues(introspectedClass));
            definition.setSetterValues(PropertyInjectionUtils.getInjectionSetterValues(introspectedClass));
        }
        return definition;
    }
