...
import com.luckyframework.jdbc.datasource.AbstractDataSource;
...
import static com.luckyframework.datasources.DataSourceManager.DEFAULT_DBNAME;

/**
 * @author fk7075
 * @version 1.0
 * @date 2021/11/8 7:25 下午
 */
public abstract class AbstractRoutingDataSource extends AbstractDataSource implements InitializingBean {
    ...
    @Nullable
    private Object defaultTargetDataSource = DEFAULT_DBNAME;

    private boolean lenientFallback = true;

    private DataSourceLookup dataSourceLookup = new LuckyDataSourceManagerLookup();
     ...
     * <p>Default is a {@link LuckyDataSourceManagerLookup}, allowing the JNDI names
     * of application server DataSources to be specified directly.
     */
    public void setDataSourceLookup(@Nullable DataSourceLookup dataSourceLookup) {
        this.dataSourceLookup = (dataSourceLookup != null ? dataSourceLookup : new LuckyDataSourceManagerLookup());
    }
    ...
    public void afterPropertiesSet() {
        ...
        LuckyDataSourceManager.getAllDataSourceNames().forEach((k)->targetDataSources.put(k,k));
        if (this.targetDataSources.isEmpty()) {
            throw new IllegalArgumentException("Property 'targetDataSources' is required");
        }
        this.resolvedDataSources = new HashMap<>(this.targetDataSources.size());
        if(resolvedDefaultDataSource == null){
            try {
                resolvedDefaultDataSource = LuckyDataSourceManager.getDataSourceByName(DEFAULT_DBNAME);
