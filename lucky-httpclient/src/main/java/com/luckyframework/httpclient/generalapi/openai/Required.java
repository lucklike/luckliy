...
public @interface Required {
     ...
     * 工具方法的表述信息
     */
    @AliasFor(annotation = Param.class, attribute = "desc")
    String desc() default "";

    /**
     * 参数名
     */
    @AliasFor(annotation = Param.class, attribute = "name")
    String name() default "";
     ...
     * </pre>
     */
    @AliasFor(annotation = Param.class, attribute = "type")
    String type() default "";

    /**
     * 枚举
     */
    @AliasFor(annotation = Param.class, attribute = "enumerate")
