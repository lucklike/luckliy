...
import com.luckyframework.httpclient.proxy.annotations.FutureUnpack;
...
@Inherited
@FutureUnpack
@HttpRequest(method = RequestMethod.OPTIONS)
public @interface FutureUnpackOptions {
