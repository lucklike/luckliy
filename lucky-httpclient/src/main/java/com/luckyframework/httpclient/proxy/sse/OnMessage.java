 ...
 * @see AnnotationStandardEventListener
 */
...
public @interface OnMessage {
     ...
     * 执行条件，默认为true
     * <pre>
     *     {@link AnnotationStandardEventListener}在初始化时会搜集所有被{@link OnMessage @OnMessage}注解标注的方法
     *     当监听到<b>onMessage</b>事件时{@link AnnotationStandardEventListener}会将事件通过@OnMessage注解的{@link OnMessage#value()}
