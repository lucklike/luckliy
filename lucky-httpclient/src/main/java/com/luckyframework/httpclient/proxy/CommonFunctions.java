...
import com.luckyframework.httpclient.generalapi.token.TokenGetter;
...
public class CommonFunctions {
    ...
    /**
     * 判断某个方法是否为获取Token的API，被{@link TokenGetter @TokenApi}注解标注的方法为TokenApi
     *
     * @param mc 方法上下文
     * @return 某个方法是否为获取Token的API
     */
    public static boolean isTokenApi(MethodContext mc) {
        return mc.isAnnotated(TokenGetter.class);
    }

    /**
     * 判断某个方法是否不是获取Token的API，被{@link TokenGetter @TokenApi}注解标注的方法为TokenApi
     *
     * @param mc 方法上下文
