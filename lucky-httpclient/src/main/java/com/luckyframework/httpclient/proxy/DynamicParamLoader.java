...
import com.luckyframework.httpclient.proxy.impl.dynamic.LookUpSpecialAnnotationDynamicParamResolver;
import com.luckyframework.httpclient.proxy.impl.dynamic.StandardHttpFileDynamicParamResolver;
import com.luckyframework.httpclient.proxy.impl.dynamic.StandardObjectDynamicParamResolver;
import com.luckyframework.httpclient.proxy.impl.setter.QueryParameterSetter;
import com.luckyframework.httpclient.proxy.impl.setter.StandardBodyParameterSetter;
import com.luckyframework.httpclient.proxy.impl.setter.StandardHttpFileParameterSetter;
...
public class DynamicParamLoader {
    ...
    public static final String ANNOTATION_ATTRIBUTE_PARAM_SETTER = "paramSetter";
    public static final String ANNOTATION_ATTRIBUTE_PARAM_SETTER_MSG = "paramSetterMsg";
    ...
    private void analyzerDynamicParamAnnotation(MethodContext methodContext) {
        for (ParameterContext parameterContext : methodContext.getParameterContexts()) {
            ...
            if (dynamicParamAnn != null) {
                TempPair<ParameterSetter, DynamicParamResolver> pair = defaultSetterResolver(parameterContext, objectCreator, dynamicParamAnn, QUERY_SETTER, LOOK_UP_SPECIAL_ANNOTATION_RESOLVER);
            ...
            // 基本类型参数
                ...
                TempPair<ParameterSetter, DynamicParamResolver> pair = defaultSetterResolver(parameterContext, objectCreator, null, QUERY_SETTER, LOOK_UP_SPECIAL_ANNOTATION_RESOLVER);
    ...
    public static TempPair<ParameterSetter, DynamicParamResolver> defaultSetterResolver(ValueContext context,
    ...
    class DynamicParamAnalyzer {
        ...
        private void resolverAndSetter(Request request, MethodContext methodContext) {
            ...
            List<? extends ParamInfo> paramInfos = resolver.parser(parameterContext, dynamicParamAnnotation);
