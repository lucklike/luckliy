...
@StaticParam(paramSetter = HeaderParameterSetter.class, paramResolver = SpELValueFieldEqualSeparationStaticParamResolver.class)
public @interface StaticHeader {

    /**
     * Header配置,格式为：key=value,支持SpEL表达式，SpEL表达式部分需要写在#{}中
     */
    String[] value();
